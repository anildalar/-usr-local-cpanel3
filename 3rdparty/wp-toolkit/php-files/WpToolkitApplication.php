...
HTML;
    ...
    private function assertSecuredConnection(): void
    {
        if ($_SERVER['HTTPS'] === 'on') {
            return;
        }

        if (file_exists('/usr/local/cpanel/3rdparty/wp-toolkit/.do-not-use-in-production.disable-https-requirement')) {
            return;
        }
