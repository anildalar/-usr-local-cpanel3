    ...
    if dict is not None:
        try:
            ...
            try:
                ...
                # If the template becomes a unicode string, then we need to make sure all of the
                # interpolated values are also unicode strings.
                sdict.decodedictfrom( GetCharSet(lang) )
