...
sub load {
    ...
    if ($varcache) {
        ...
        my $analytics_nvdata        = Cpanel::API::NVData::_get('analytics')->[0]{value}             || "";
        my $personhood_nvdata       = Cpanel::API::NVData::_get('personhood')->[0]{value}            || "";
        ...
        $varcache->set( 'analytics',                $analytics_nvdata );
        $varcache->set( 'personhood',               $personhood_nvdata );
    }
