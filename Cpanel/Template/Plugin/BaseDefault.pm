...
=head2 _is_server_analytics_enabled()
...
sub _is_server_analytics_enabled {
    my ($self) = @_;
    return ( Cpanel::Analytics::UiIncludes::are_enabled() && $ENV{'DNT'} ne '1' );
}
