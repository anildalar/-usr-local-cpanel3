...
our %Conf = (
    ...
    'arc_signing' => {
        'default'  => 0,
        'type'     => 'binary',
        'excludes' => 'acl_dkim_disable',    # negation var. acl_dkim_disable = 1 , disabled, by default. arc requires it to be 0, enabled.
                                             # Note that we use an SPF check in etc/exim/acls/ACL_RECIPIENT_BLOCK/default_recipient when enabled
    },
    'spf_include_hosts' => {
        'default_text' => 'None',
        'default'      => '',
