...
=head2 $yn = new_account_can_have_reseller()

Indicates whether the server can have reseller

=cut

sub new_account_can_have_reseller {
    return 0 if Cpanel::Server::Type::is_wp_squared();
    return 1;
}
