...
window.get_goto = function(appOrUri) {
    ...
    for ( let i = 0; i < exploded.length; i++ ) {
        ...
        // Possibly could ban other params from piggybacking here?
        otherParams.push( exploded[i] + "=" + exploded[++i] );
    }
    ...
    // Tack on any other params from QUERY_STRING that may be here to goto_uri
    if ( appOrUri === "uri" && otherParams.length ) {
        ret = ret + "?" + otherParams.join("&");
    }
